...
return {
  ...
  -- (/opt/lua-language-server, root-owned in the image) — which fails as uid
  -- 1000 with "Permission denied" and the server never attaches. Redirect both
  -- to a user-writable cache dir.
  cmd = {
    "lua-language-server",
