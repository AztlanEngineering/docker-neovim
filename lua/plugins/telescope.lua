return {
  { "nvim-telescope/telescope.nvim",
    ...
    keys = {
        ...
        { "=", "<CMD>Telescope find_files<CR>", mode = { "n", "i", "v" } },  -- Shortcut for finding files
        { ";", "<CMD>lua require('telescope.builtin').buffers({ sort_lastused = true })<CR>", mode = { "n", "i", "v" } },  -- Shortcut for searching buffers
